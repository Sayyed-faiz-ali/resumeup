...
function Login() {
  ...
  return (
    <div 
      className="min-h-screen flex items-center justify-center font-sans text-white bg-cover bg-center"
      style={{ backgroundImage: "url('/lo.jpg')" }}
    >
      <div className="rounded-xl shadow-lg p-10 max-w-sm w-full text-center backdrop-blur-md">
